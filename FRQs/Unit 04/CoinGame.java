...
public class CoinGame
    {
        ...
        public int getPlayer1Move()
        {
            ...
            System.out.println("getPlayer1Move=> " + result);
            return result;
        }
        ...
        public int getPlayer2Move(int round)
        {
            ...
            System.out.println("getPlayer2Move=> " + result);
            return result;
        }
        ...
        public void playGame()
        {
            ...
            for(int r=1; r<=maxRounds; r++) {
                ...
                System.out.println("... after round, player1 has " + p1coins);
                System.out.println("... after round, player2 has " + p2coins);

                // check end game condition
                if(p1coins < 3 || p2coins < 3) {
                    System.out.println("playGame aborted after round# " + r);
                    break;
                }
            }
